...
export class TraktService {
    ...
    async getSeasonEpisodes(serviceId: number, traktId: number, seasonNumber: number) {
        return this.makeRequest(serviceId, `/shows/${traktId}/seasons/${seasonNumber}`, {
            extended: 'full,images',
        });
    }
    ...
    async searchQuery(serviceId: number, query: string, type: string = 'movie,show') {
        return this.makeRequest(serviceId, `/search/${type}`, {
            query,
            extended: 'full,images'
        });
    }
