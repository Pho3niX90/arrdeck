...
export class AiRecommendationsService {
  ...
  getRecommendations(serviceId: number, type: 'sonarr' | 'radarr', prompt?: string, forceRefresh?: boolean): Observable<RecommendationResponse> {
    return this.http.post<RecommendationResponse>(this.apiUrl, {serviceId, type, prompt, forceRefresh});
  }
